...
app = Flask(__name__)
app.config['SECRET_KEY'] = b'+\xe7\xa4\x1d\x10\x85v8q\xd4\x01A\x99E\x81\xba\x9a\xa4\xc6g\x93\x9e\xb2\xf5'
...
def question(question_id):
    ...
    return render_template('question.html', user=user, questions = questions)
...
def answer(question_id):
    ...
    question_res = db.fetchone()
    
    return render_template('answer.html', user=user, question=question_res)
